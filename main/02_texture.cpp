...
void HelloTextureDrawingProgram::Init()
{
	...
	shaderProgram.Init(
		"shaders/02_texture/texture.vert",
#ifdef OTHER_TEXTURE
		"shaders/02_texture/texture_other.frag"
#else
		"shaders/02_texture/texture.frag"
#endif
	);
	textureWall = gliCreateTexture("data/sprites/wall.dds");
#ifdef OTHER_TEXTURE
	textureOtherPlay = gliCreateTexture("data/sprites/other_play.dds");
#endif
